...
RUN cd /comfyui/custom_nodes && git clone https://github.com/city96/ComfyUI-GGUF
RUN cd /comfyui/custom_nodes/ComfyUI-GGUF && . /comfyui/venv/bin/activate && pip3 install --upgrade gguf
